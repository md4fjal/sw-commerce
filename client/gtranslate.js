(function () {
  ...
  var default_language = gt.default_language || "en";
  ...
  widget_css +=
    ".gt_float_switcher{font-family:Arial;font-size:20px;border-radius:2px;color:#555;display:inline-block;line-height:20px;background:#fff;overflow:hidden;transition:all .5s cubic-bezier(0.4, 0, 1, 1)}";
  widget_css +=
    ".gt_float_switcher img{vertical-align:middle;display:inline-block;width:23px;height:auto;margin:0 2px 0 0;border-radius:3px}";
  if (
    ...
    widget_css +=
      ".gt_float_switcher .gt_options a{display:block; font-size: 15px; text-decoration:none;padding:" +
      (flag_style == "3d" ? 6 : 10) +
      "px 15px;color:#444;transition:color .4s linear}";
    widget_css +=
  ...
  widget_css +=
    ".gt_float_switcher .gt-selected .gt-current-lang span.gt-lang-code{position:relative;top:2px; font-size: 15px}";
